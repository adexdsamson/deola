    ...
    <ul className="overflow-x-auto w-full items-center flex flex-wrap gap-8 snap-x">
      {data.map(({ company, position, content, duration, icon }, i) => (
        <li key={i} className="snap-center">
          <div className="shadow-lg rounded-xl h-52 w-72 max-w-[40vw] md:w-96 p-4 bg-primary/30 relative overflow-hidden">
            <a href="#" className="w-full h-full block">
              <div className="flex items-center border-b-2 mb-2 py-2">
                ...
                <div className="pl-3">
                  ...
                  <div className="flex py-1 items-center">
                    ...
                    <div className="text-gray-700 rounded-full bg-secondary px-2 py-0.5 text-sm ml-1">
                      {duration}
                    </div>
                  </div>
                </div>
              ...
              <div className="w-full h-2 bg-secondary rounded-full absolute bottom-2 right-1 left-1">
